...
const AdminDashboard = () => {
  ...
  const fetchSummary = async () => {
    try {
      const response = await fetch(
        "https://gammaridgev2-server.vercel.app/api/admin/summary",
        {
  ...
  const fetchLoans = async () => {
    try {
      const response = await fetch(
        "https://gammaridgev2-server.vercel.app/api/admin/loans",
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      );
  ...
  const fetchActivityLogs = async () => {
    try {
      const response = await fetch(
        "https://gammaridgev2-server.vercel.app/api/admin/activity-logs",
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      );
  ...
  const fetchLoanStats = async () => {
    try {
      const response = await fetch(
        "https://gammaridgev2-server.vercel.app/api/admin/loan-stats",
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      );
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch(
        "https://gammaridgev2-server.vercel.app/api/admin/users",
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      );
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch(
        "https://gammaridgev2-server.vercel.app/api/admin/notifications",
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      );
  ...
  const approveLoan = async (loanId) => {
    try {
      const response = await fetch(
        `https://gammaridgev2-server.vercel.app/api/admin/approve-loan/${loanId}`,
        {
          method: "PUT",
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
  ...
  const handlePartialPayment = async () => {
    ...
    try {
      const response = await fetch(
        `https://gammaridgev2-server.vercel.app/api/admin/partial-payment/${selectedLoan._id}`,
        {
          method: "PUT",
          headers: {
  ...
  const markLoanAsPaid = async () => {
    try {
      const response = await fetch(
        `https://gammaridgev2-server.vercel.app/api/admin/mark-paid/${selectedLoan._id}`,
        {
          method: "PUT",
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const response = await fetch(
        `https://gammaridgev2-server.vercel.app/api/admin/delete/${userToDelete}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const toggleUserStatus = async (userId, isActive) => {
    try {
      const response = await fetch(
        `https://gammaridgev2-server.vercel.app/api/admin/toggle-user-status/${userId}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const updateCredentials = async () => {
    try {
      const response = await fetch(
        "https://gammaridgev2-server.vercel.app/api/admin/update-credentials",
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
